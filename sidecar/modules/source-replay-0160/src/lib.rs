//! `source_replay`, built against the vendored `ffrwd:av@0.16.0` world
...
//! module the host's 0.16.0 arm is proven against: a source built before the
//! 0.17.0 bump still loads, opens and pulls under a 0.17.0 host.
//!
