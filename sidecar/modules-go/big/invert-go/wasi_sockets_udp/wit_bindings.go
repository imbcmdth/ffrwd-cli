...
func (self *UdpSocket) Subscribe() *wasi_io_poll.Pollable {
...
func (self *IncomingDatagramStream) Subscribe() *wasi_io_poll.Pollable {
...
func (self *OutgoingDatagramStream) Subscribe() *wasi_io_poll.Pollable {
